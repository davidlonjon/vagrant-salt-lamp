...
default_vhost_apache:
  file:
    ...
    - defaults:
       ...
       doc_root: {{ "/home/vagrant/www/project.dev/public_html" if pillar['default_vhost']['doc_root'] is not defined else pillar['default_vhost']['doc_root'] }}
...
vhost_doc_root:
  file:
    - directory
    - makedirs: True
    - name: {{ "/home/vagrant/www/project.dev/public_html" if pillar['default_vhost']['doc_root'] is not defined else pillar['default_vhost']['doc_root'] }}
    - dir_mode: 0755
    - mode: 0644
...
default_vhost_index:
  file:
    ...
    - name: {{ "/home/vagrant/www/project.dev/public_html" if pillar['default_vhost']['doc_root'] is not defined else pillar['default_vhost']['doc_root'] }}/index.php
    - template: jinja
    - makedirs: True
    - mode: 644
    - defaults:
